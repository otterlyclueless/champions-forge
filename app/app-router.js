...
async function shareImage(kind,id){
  ...
  try{
    ...
    // finish decoding before html2canvas reads the DOM. Without this the
    // capture can fire while imgs are still 0×0 and sprites render blank.
    ...
    console.log('shareImage error:',e);
